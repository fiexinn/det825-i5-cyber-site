  ...
  return (
    <SpaceLayout>
      ...
      <div className="fixed right-4 top-24 z-20 hidden lg:block">
        <div className="rounded-xl p-4 border border-primary/20 backdrop-blur-sm" style={{ background: "hsl(var(--card-bg-alpha) / 0.7)" }}>
          <p className="font-mono text-[0.6rem] tracking-[0.3em] text-primary/50 mb-1">ADVISOR</p>
          <div className="font-display text-sm font-bold text-accent">Capt. Ulman</div>
          <div className="text-[0.7rem] text-muted-foreground mt-0.5 tracking-wider">Squadron Advisor</div>
        </div>
      </div>
      {/* Advisor - mobile (inline small) */}
      <div className="relative z-10 flex justify-end px-6 pt-4 lg:hidden">
        <div className="rounded-xl p-3 px-5 border border-primary/20 backdrop-blur-sm" style={{ background: "hsl(var(--card-bg-alpha) / 0.7)" }}>
          <p className="font-mono text-[0.6rem] tracking-[0.3em] text-primary/50 mb-1">ADVISOR</p>
          <div className="font-display text-sm font-bold text-accent">Capt. Ulman</div>
          <div className="text-[0.7rem] text-muted-foreground mt-0.5">Squadron Advisor</div>
        </div>
      </div>
